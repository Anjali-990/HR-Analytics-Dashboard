...
![](Dashboard/Dashboard_Charts/JobSatisVSAttrition.PNG)
![](Dashboard/Dashboard_Charts/ExpDistribution.PNG)
![](Dashboard/Dashboard_Charts/AttritionByJobRole.PNG)
![](Dashboard/Dashboard_Charts/AgeWiseAnalysis.PNG)
![](Dashboard/Dashboard_Charts/OverTimeVsAttrition.PNG)
![](Dashboard/Dashboard_Charts/WorkLifeVSAttrition.PNG)

---

## SQL Queries Results

![](SQL/SQL_Query_Results/JobsatisfactionVSAttrition.PNG)
![](SQL/SQL_Query_Results/overtimeVSAttrition.PNG)
![](<SQL/SQL_Query_Results/avgMonthlyIncome(departmentwise).PNG>)
![](SQL/SQL_Query_Results/Attrition_by_jobrole.PNG)
![](SQL/SQL_Query_Results/work_lifebalanceVsAttrition.PNG)
